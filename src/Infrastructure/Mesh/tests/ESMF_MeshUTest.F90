...
!  if (localrc .ne. ESMF_SUCCESS) rc=ESMF_FAILURE
  ...
  !-----------------------------------------------------------------------------
  !NEX_UTest
  write(name, *) "Mesh create easy elems connect"
  write(failMsg, *) "Did not return ESMF_SUCCESS"
  ...
  ! do test
  call test_mesh_create_ee_conn(correct, rc)
...
subroutine test_mesh_create_ee_conn(correct, rc)
  type(ESMF_Mesh) :: mesh
  logical :: correct
  integer :: rc
  integer :: numElems,numOwnedElemsTst
  ...
  if (petCount .eq. 1) then
      ...
      !! elem coords
      allocate(elemCoords(2,numElems))
      elemCoords(:,1)=(/0.7,0.7/)   ! 1
      elemCoords(:,2)=(/2.3,0.7/)   ! 3
      elemCoords(:,3)=(/0.7,2.3/)   ! 7
      elemCoords(:,4)=(/2.75,2.25/) ! 9
      elemCoords(:,5)=(/2.25,2.75/) ! 10
     ...
     allocate(elemCornerCoords(2,numElemCorners))
     elemCornerCoords(:,1)=(/0.0,0.0/) ! 1
     elemCornerCoords(:,2)=(/1.4,0.0/) ! 1
     elemCornerCoords(:,3)=(/1.4,1.4/)  ! 1
     elemCornerCoords(:,4)=(/0.0,1.4/)  ! 1
     elemCornerCoords(:,5)=(/1.6,0.0/)  ! 3
     elemCornerCoords(:,6)=(/3.0,0.0/)  ! 3
     elemCornerCoords(:,7)=(/3.0,1.4/)  ! 3
     elemCornerCoords(:,8)=(/1.6,1.4/)  ! 3
     elemCornerCoords(:,9)=(/0.0,1.6/)  ! 7
     elemCornerCoords(:,10)=(/1.4,1.6/)  ! 7
     elemCornerCoords(:,11)=(/1.4,3.0/)  ! 7
     elemCornerCoords(:,12)=(/0.0,3.0/)  ! 7
     elemCornerCoords(:,13)=(/1.6,1.6/)  ! 9
     elemCornerCoords(:,14)=(/3.0,1.6/)  ! 9
     elemCornerCoords(:,15)=(/3.0,3.0/)  ! 9
     elemCornerCoords(:,16)=(/1.6,1.6/)  ! 10
     elemCornerCoords(:,17)=(/3.0,3.0/)  ! 10
     elemCornerCoords(:,18)=(/1.6,3.0 /)  ! 10
     ...
     elemCornerCoords(:,4)=(/0.0,1.4/)   ! 1
      ...
      !! elem coords
      allocate(elemCoords(2,numElems))
      elemCoords(:,1)=(/2.3,0.7/) ! 3

     !! elem corner Coords
     allocate(elemCornerCoords(2,numElemCorners))
     elemCornerCoords(:,1)=(/1.6,0.0/)  ! 3
     elemCornerCoords(:,2)=(/3.0,0.0/)  ! 3
     elemCornerCoords(:,3)=(/3.0,1.4/)  ! 3
     elemCornerCoords(:,4)=(/1.6,1.4/)  ! 3
      ...
      !! elem coords
      allocate(elemCoords(2,numElems))
      elemCoords(:,1)=(/0.7,2.3/) ! 7
      elemCoords(:,2)=(/2.75,2.25/) ! 9
      elemCoords(:,3)=(/2.25,2.75/) ! 10

     !! elem corner Coords
     allocate(elemCornerCoords(2,numElemCorners))
     elemCornerCoords(:,1)=(/0.0,1.6/)  ! 7
     elemCornerCoords(:,2)=(/1.4,1.6/)  ! 7
     elemCornerCoords(:,3)=(/1.4,3.0/)  ! 7
     elemCornerCoords(:,4)=(/0.0,3.0/)  ! 7
     elemCornerCoords(:,5)=(/1.6,1.6/)  ! 9
     elemCornerCoords(:,6)=(/3.0,1.6/)  ! 9
     elemCornerCoords(:,7)=(/3.0,3.0/)  ! 9
     elemCornerCoords(:,8)=(/1.6,1.6/)  ! 10
     elemCornerCoords(:,9)=(/3.0,3.0/)  ! 10
     elemCornerCoords(:,10)=(/1.6,3.0 /)  ! 10
   ...
   ! Output Mesh for debugging
   call ESMF_MeshWrite(mesh,"mesheeconn",rc=localrc)
   if (localrc .ne. ESMF_SUCCESS) rc=ESMF_FAILURE

   ! Return success
   rc=ESMF_SUCCESS

end subroutine test_mesh_create_ee_conn
